...
def generate_recommendations(merged_forecasts_ranges, recommendation_date) -> pd.DataFrame:
    ...
    prospect_df['DATE'] = pd.date_range(start=recommendation_date, periods=30)
